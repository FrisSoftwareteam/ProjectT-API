...
$jsonPayloads = [
    ...
    'ShareholderChangeRequestController@store' => [
        'first_name' => 'Ada',
        'last_name' => 'Okafor',
        'email' => 'ada.updated@example.com',
        'phone' => '08012345678',
        'address' => [
            'address_line1' => '2 Marina Road',
            'address_line2' => null,
            'city' => 'Lagos',
            'state' => 'Lagos',
            'postal_code' => '100001',
        ...
        'reason' => 'Shareholder submitted updated profile details',
    ],
    'ShareholderChangeRequestController@approve' => ['remarks' => 'Supporting documents reviewed and approved'],
    'ShareholderChangeRequestController@reject' => ['remarks' => 'Supporting documents do not match the proposed update'],
...
$queryExamples = [
    ...
    'ShareholderChangeRequestController@index' => [
        'status' => 'submitted',
        'search' => 'Ada',
    ...
    'CscsUploadController@transactions' => ['balance_status' => 'UNBALANCED', 'per_page' => '50', 'page' => '1'],
