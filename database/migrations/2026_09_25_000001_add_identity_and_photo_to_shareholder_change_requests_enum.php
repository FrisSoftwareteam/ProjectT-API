...
return new class extends Migration
{
    public function up(): void
    {
        DB::statement("
            ...
            ENUM('email_change','phone_change','address_change','bank_mandate','name_change','status_change','cscs_update','chn_update','profile_update','identity_change','profile_picture_change') NOT NULL
        ");
    }
